...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 13 11:57:14 2020
...
spike_source_6 = sim.Population(1, sim.SpikeSourceArray(
    spike_times = spike_time_for_id_6))
...
spike_2_conn_for_6 = sim.Projection(spike_source_6, cann_pop[6:7], sim.OneToOneConnector(),
                      sim.StaticSynapse(weight = 0.002, delay = 0.1))
