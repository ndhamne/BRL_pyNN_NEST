...
A neuron which is not in the adjacent neighbourhood is spiked with similar number of spikes to see if the activity shifts abruptly, but it does move. This is neuro-plausible as well becasue the agent would only move with smoothly as opposed to the kidnapped robot scenario.
