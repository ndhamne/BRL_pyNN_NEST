...
conn = sim.Projection(spike_source, neuron1[spiky:spiky+1], sim.AllToAllConnector(),
...
Figure(
       ...
       Panel(data1.spiketrains, xlabel = "Time (ms)", yticks = True),
       Panel(data2.spiketrains, xlabel = "Time (ms)", yticks = True, xticks = True)
)
